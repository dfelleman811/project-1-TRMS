...
public class DevelopmentResources {
	...
	public DevelopmentResources(Date startDate, Date resourceTime, String resourceLocation, int resourceCost,
	...
	public DevelopmentResources(int resourceId, Date startDate, Date resourceTime, String resourceLocation,
	...
	public String toString() {
		return "DevelopmentResources [resourceId=" + this.resourceId + ", startDate=" + this.startDate + ", resourceTime="
				+ this.resourceTime + ", resourceLocation=" + this.resourceLocation + ", resourceCost=" + this.resourceCost
				+ ", gradingFormatId=" + this.gradingFormatId + ", resourceType=" + this.resourceType + ", resourceDescription="
				+ this.resourceDescription + ", resourceJustification=" + this.resourceJustification + "]";
	}
